...
def gen_frames():
    ...
    while True:
        ...
        # If face_recognition is not available, just stream raw frames
        ...
        # Display the results (draw on original frame)
...
def video_feed():
    ...
    if conn:
        try:
            ...
            print("Warning: failed to write to DB in /video_feed:", e)
    else:
        print("DB not available: skipping insert in /video_feed")
